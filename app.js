...
//     $('.item[data-filter-name="' + selectedEventType + '"]').removeClass(
//       "hidden"
//     );
//   }
// });
...
// topicSelectFilter function

const topicSelectFilter = () => {
  let selectedTopic = document.getElementById("filterByTopic").value;
  // querySelectorAll ih spakuje u NodeList-u sto je slicno Array-u, pa mozemo mapirati kroz istu
  const cards = document.querySelectorAll(".val");
  for (let i = 0; i < cards.length; i++) {
    if (cards[i].classList.contains(selectedTopic) || selectedTopic === "all") {
